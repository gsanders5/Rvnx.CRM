...
public class ContactReadService(IRepository repository, IFavoriteService favoriteService) : IContactReadService
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Globalization", "CA1304:Specify CultureInfo", Justification = "EF Core cannot translate CultureInfo — .ToLower() is used for SQLite-compatible case-insensitivity.")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Globalization", "CA1311:Specify a culture or use an invariant version", Justification = "EF Core cannot translate CultureInfo — .ToLower() is used for SQLite-compatible case-insensitivity.")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA1862:Use the 'StringComparison' method overloads to perform case-insensitive string comparisons", Justification = "EF Core cannot translate StringComparison — .ToLower() is used for SQLite-compatible case-insensitivity.")]
