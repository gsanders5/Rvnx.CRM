...
public class SelfContactTests
{
    ...
    private static ContactsController CreateController(Mock<ISelfContactService> selfContactServiceMock)
    {
        ...
        ContactsController controller = new(loggerMock.Object, userMock.Object, new Mock<IContactImportService>().Object, new Mock<IContactExportService>().Object, new Mock<IContactManagementService>().Object, new Mock<IContactReadService>().Object, selfContactServiceMock.Object, syncMock.Object, Mock.Of<IFileValidationService>())
        {
