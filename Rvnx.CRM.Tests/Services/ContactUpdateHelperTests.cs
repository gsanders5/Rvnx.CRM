...
public class ContactUpdateHelperTests
{
    ...
    [Fact]
    public async Task UpdateOrAddContactMethodAsyncWithInvalidPhoneThrowsValidationException()
    {
        Guid contactId = Guid.NewGuid();

        await Assert.ThrowsAsync<ValidationException>(() =>
            ContactUpdateHelper.UpdateOrAddContactMethodAsync(_repositoryMock.Object, contactId, ContactMethodType.Phone, "invalid_phone", null));
