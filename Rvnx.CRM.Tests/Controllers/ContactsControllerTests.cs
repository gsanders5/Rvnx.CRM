...
public class ContactsControllerTests
{
    public class ContactsControllerDetailsTests
    {
        ...
        public async Task DetailsShouldReturnViewWithMappedRelationships()
        {
            ...
            ContactsController controller = new(loggerMock.Object, userMock.Object, syncMock.Object, Mock.Of<IContactImportService>(), Mock.Of<IContactExportService>(), Mock.Of<IContactManagementService>(), readServiceMock.Object, Mock.Of<ISelfContactService>(), Mock.Of<IFileValidationService>())
            {
