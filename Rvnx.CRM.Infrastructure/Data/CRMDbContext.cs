...
public class CRMDbContext(DbContextOptions<CRMDbContext> options, ICurrentUserService currentUserService) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pet>().Property(p => p.Species).HasMaxLength(50);
        modelBuilder.Entity<Pet>().Property(p => p.Breed).HasMaxLength(100);
        ...
        modelBuilder.Entity<Fact>().Property(f => f.Category).IsRequired().HasMaxLength(100);
        modelBuilder.Entity<Fact>().Property(f => f.Value).IsRequired().HasMaxLength(500);
