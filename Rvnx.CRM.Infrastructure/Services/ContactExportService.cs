...
public class ContactExportService(IRepository repository, IVCardService vCardService) : IContactExportService
{
        ...
        params string[] includes) where T : BaseEntity
    {
        ...
        // to avoid allocations of intermediate IGrouping structures and redundant list iterations.
        // Expected impact: Reduces memory overhead and garbage collection pauses during large bulk exports.
