...
namespace Rvnx.CRM.Infrastructure.Migrations
{
    ...
    {
        private static readonly string[] ContactLabelColumns = ["ContactId", "LabelId"];
        private static readonly string[] RelationshipEntityColumns = ["EntityId", "EntityType"];
        private static readonly string[] RelationshipRelatedEntityColumns = ["RelatedEntityId", "EntityType"];
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Relationship",
                columns: RelationshipEntityColumns);

            migrationBuilder.CreateIndex(
                name: "IX_Relationship_RelatedEntityId_EntityType",
                table: "Relationship",
                columns: RelationshipRelatedEntityColumns);
